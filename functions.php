...
session_start();
// koneksi ke database
$koneksi = mysqli_connect("localhost", "root", "" , "arsip_b2tke2") or die;
...
function tambah($data){
	...
	// query insert data
	$query = "INSERT INTO arsip_dokumen (kode_rak, kode_box, kode_ordner, kode_arsip, no_akun, bidang, sub_bidang, kegiatan, tahun, status_arsip, Berkas) 
		VALUES ('$kode_rak', '$kode_box', '$kode_ordner', '$kode_arsip', '$no_akun', '$bidang', '$sub_bidang', '$kegiatan', '$tahun', '$status_arsip', '$berkas');
			";
