      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 bg-white p-4 login">
          ...
          <div class="card text-center border-0">
            ...
            <div class="card-body">
              <h4 class="card-text">BADAN KEPEGAWAIAN DAN PENGEMBANGAN SUMBER </h4>
            </div>
          </div>
          <?php if ( isset($error)) : ?>
          ...
          <form action="" method="post">
            ...
            <p style=" font-family: arial; font-size: 12px; margin-top: 10%; font-weight: bold;">COPYRIGHT &copy; <?= date('Y'); ?> BKD</p>
          </form>
        </div>
      </div>
    </div>
