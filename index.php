	...
	<div class="container-fluid">
		<div class="row marquee justify-content-center">
			<div class="col-md-6 mt-2 mb-3">
	          <marquee scrollamount="10" loop="infinite" direction="right" class="nav-link text-white p-2 bg-info rounded text-center"><h4><?= salam(); ?>, <?= ucfirst($_SESSION['nama']); ?></h4></marquee>
			</div>
		</div>
		<div class="row h3">
			<div class="col">
			...
			<div class="col">
				<table rules="all" border="2" cellpadding="10" cellspacing="0" class="table bg-white table-bordered table-hover table-primary shadow-box">
					...
					<tr class="text-center">
						...
						<td><a href="downloadFile.php?url=<?php echo $row['Berkas']; ?>">Download File</a></td>
					</tr>
					<?php $i++; ?>
					<?php endforeach; ?>		
				</table>
...
<div class="footer">
	COPYRIGHT &copy; <?= date('Y'); ?> BADAN KEPEGAWAIAN DAN PENGEMBANGAN SUMBER DAYA MANUSIA
</div>
