...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2023 at 03:28 PM
...
INSERT INTO `arsip_dokumen` (`id_arsip_dokumen`, `kode_rak`, `kode_box`, `kode_ordner`, `kode_arsip`, `no_akun`, `bidang`, `sub_bidang`, `kegiatan`, `tahun`, `status_arsip`, `Berkas`) VALUES
(113, '143', '143', '143', 'KP.12.00', '12', 'pelayanan teknologi', 'layanan jasa', 'Vaza Aprilian', 2023, 'ada', 'img/2111102441092 - Vaza Aprilian Habar KMH.pdf'),
(114, '123', '143', '143', 'EM.04', '1215468', 'pelayanan teknologi', 'program', 'gk ada', 2022, 'ada', 'img/Hena Rahmawati, A.Md.Keb.pdf'),
(115, '124', '124', '14', 'KP.14', '14', 'pelayanan teknologi', 'program', 'lils', 2022, 'ada', 'pdf/Surat Permohonan Izin Mahasiswa PKL Bu Asslia.pdf');
...
(1, 'vazaaprilian', '$2y$10$RWg0j53yStyCAvG8blaM4uOb1uIyenq5a1bwVdTUDItkLEXZTJo32', 'Vaza Aprilian H', '2111102', 'administrator');
...
--
ALTER TABLE `arsip_dokumen`
  MODIFY `id_arsip_dokumen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;
